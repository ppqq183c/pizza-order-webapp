...
function showModalConfirm(custName, kana, accountName, password, tel, address, birthDay) {
	...
	document.getElementById('modalConfirm_password').value = password;
	document.getElementById('modalConfirm_tel').value = tel;
	document.getElementById('modalConfirm_address').value = address;
	document.getElementById('modalConfirm_birthDay').value = birthDay;
	...
	document.getElementById('modalConfirm_birthDay_text').textContent = birthDay;
	modal.show();
}
  ...
  if (!form.checkValidity()) {
    ...
    return false;
	  ...
	  custName = document.getElementById('custName').value;
		...
		showModalConfirm(custName, kana, accountName, password, tel,address, birthDay);
	  }
  return false;
}
function showConfirm(message, kind) {
	if (kind == "error") {
...
window.onload = function() {
	...
	<%if (errorMsg != null) {%>
	  showConfirm("<%=errorMsg%>", "error");
	<%} else if (checkErrorMsg != null) {%>
	  showConfirm("<%=checkErrorMsg%>", "warning");
	<%} else if (msgFlag != null) {%>
	  showConfirm("会員情報の更新が正常に完了しました。", "info");
	<%}%>
...
<body>
	...
	<main class="container my-5 pt-2">
		<h2 class="text-center fw-bold mb-4">会員情報登録</h2>
				...
				<div class="card shadow-sm">
					<div class="card-body p-4">
						...
						<form id="orderForm" novalidate onsubmit="return checkSubmit();">
							...
							<div class="row mb-3">
								<div class="position-relative">
									<label class="form-label">パスワード <span
										...
										id="password" placeholder="英数字8文字以上"
										class="form-control form-control-lg required-field" required
							...
							<div class="row mb-3">
								<div class="position-relative">
									...
									<input type="text" id="address"
										placeholder="例：東京都千代田区神田小川町１－８－５"
										class="form-control form-control-lg required-field" required>
									<span class="check-icon">✓</span>
								</div>
							</div>
							...
							<div class="row mb-4">
								<div class="position-relative">
									<label class="form-label">生年月日 <span
										class="text-danger">*</span></label> <input type="date" id="birthDay"
										placeholder=""
										class="form-control form-control-lg required-field" required>
									<span class="check-icon">✓</span>
								</div>
				...
				<div class="modal-content position-relative border-0 bg-transparent">
					...
					<div class="card shadow-lg mx-auto"
						...
						<div class="card-body p-4">
							...
							<div class="row mb-2 align-items-center">
								<div class="col-4 fw-bold text-end">パスワード：</div>
								<div class="col-8">
							...
							<div class="row mb-2 align-items-center">
								<div class="col-4 fw-bold text-end">生年月日：</div>
								<div class="col-8">
									<span id="modalConfirm_birthDay_text"
										class="form-control-plaintext"></span>
								</div>
							</div>
					...
					<div class="card shadow-lg text-center mx-auto modal-card">
						<div class="card-body p-2 p-md-4">
							...
							<p class="text-muted mb-4">
								会員情報の登録が<br class="d-sm-none"> 正常に完了しました。
							</p>
				...
				<div class="modal-content border-0 bg-transparent">
					...
					<div class="card shadow-lg text-center mx-auto modal-card">
						<div class="card-body p-3 p-md-4">
							...
							<!-- タイトル -->
							<h5 class="fw-bold text-danger mb-2">登録に失敗しました</h5>
	...
	<form action="KiddaLaController" method="post" id="fm7">
		...
		<input type="hidden" name="password" id="modalConfirm_password">
		<input type="hidden" name="tel" id="modalConfirm_tel"> <input
			type="hidden" name="address" id="modalConfirm_address"> <input
			type="hidden" name="birthDay" id="modalConfirm_birthDay"> <input
			type="hidden" name="command" value="CustomerRegister">
	</form>
</body>
</html>
